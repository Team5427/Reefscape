...
/**
 * Inverse kinematics for robotic arms. This is for arms with fixed arm segments
 * and 2 joints. This
 * DOES NOT recalculate if joint angles are calculated to violate constraints.
 * Target Location is
