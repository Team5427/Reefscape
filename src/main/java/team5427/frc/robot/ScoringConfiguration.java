...
public class ScoringConfiguration {
  ...
  public ScoringConfiguration(
      Pose2d drivetrain,
      Distance cascadeLength,
      Rotation2d cascadePivotAngle,
      Rotation2d endEffectorPivotAngle,
      Rotation2d endEffectorWristAngle,
      LinearVelocity coralFlywheelSpeed,
      LinearVelocity algaeFlywheelSpeed) {
