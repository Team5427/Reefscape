...
public class EndEffectorIOSim implements EndEffectorIO {
        ...
        public EndEffectorIOSim() {
                pivotMotor = new DCMotorSim(
                                LinearSystemId.createDCMotorSystem(
                                                ...
                                                pivotMotorInertia,
                                                EndEffectorConstants.kPivotMotorConfiguration.gearRatio
                ...
                wristMotor = new DCMotorSim(
                                LinearSystemId.createDCMotorSystem(
                                                EndEffectorConstants.kWristMotorConfiguration.withFOC
                                                                ...
                                                                : DCMotor.getKrakenX60(1),
                                                wristMotorInertia,
                                                EndEffectorConstants.kWristMotorConfiguration.gearRatio
                                                                .getMathematicalGearRatio()),
                                EndEffectorConstants.kWristMotorConfiguration.withFOC ? DCMotor.getKrakenX60Foc(1)
                                                : DCMotor.getKrakenX60(1));
                coralRollerMotor = new DCMotorSim(
                                LinearSystemId.createDCMotorSystem(
                                                ...
                                                EndEffectorConstants.kCoralRollerMotorConfiguration.gearRatio
                                                                .getMathematicalGearRatio()),
                                EndEffectorConstants.kCoralRollerMotorConfiguration.withFOC ? DCMotor.getKrakenX60Foc(1)
                                                : DCMotor.getKrakenX60(1));
                algaeRollerMotor = new DCMotorSim(
                                LinearSystemId.createDCMotorSystem(
                                                ...
                                                EndEffectorConstants.kAlgaeRollerMotorConfiguration.gearRatio
                                                                .getMathematicalGearRatio()),
                                EndEffectorConstants.kAlgaeRollerMotorConfiguration.withFOC ? DCMotor.getKrakenX60Foc(1)
                                                : DCMotor.getKrakenX60(1));
        }
        ...
        public void updateInputs(EndEffectorIOInputs inputs) {
                ...
                inputs.algaeRollerMotorLinearVelocity = MetersPerSecond.of(algaeRollerMotor.getAngularVelocityRPM()
                                * EndEffectorConstants.kAlgaeRollerMotorConfiguration.finalDiameterMeters * Math.PI
                                / 60.0);
                ...
                inputs.coralRollerMotorLinearVelocity = MetersPerSecond.of(coralRollerMotor.getAngularVelocityRPM()
                                * EndEffectorConstants.kCoralRollerMotorConfiguration.finalDiameterMeters * Math.PI
                                / 60.0);
