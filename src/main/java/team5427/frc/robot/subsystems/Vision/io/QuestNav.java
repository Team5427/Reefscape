...
public class QuestNav {
  ...
  public void zeroHeadingBAD() {
    yaw_offset = (float) Rotation2d.fromDegrees(0).minus(getPose().getRotation()).getDegrees();
  }
  ...
  public void zeroPosition() {
    ...
    // resetPosition = new Pose2d(4, -10, Rotation2d.fromDegrees(90));
    if (questMiso.get() != 99) {
      questMosi.set(1);
    }
  }
