...
// import team5427.frc.robot.subsystems.Vision.io.LimelightHelpers.LimelightResults;
// import team5427.frc.robot.subsystems.Vision.io.LimelightHelpers.PoseEstimate;
...
// boolean isMegaTag2) {
//         DoubleArrayEntry poseEntry = LimelightHelpers.getLimelightDoubleArrayEntry(limelightName,
// entryName);
...
//     public static DoubleArrayEntry getLimelightDoubleArrayEntry(String tableName, String
// entryName) {
...
//     public static void setLimelightNTDoubleArray(String tableName, String entryName, double[]
// val) {
...
//     /**
//      * Gets the horizontal offset from the principal pixel/point to the target in degrees.  This
// is the most accurate 2d metric if you are using a calibrated camera and you don't need adjustable
...
// the most accurate 2d metric if you are using a calibrated camera and you don't need adjustable
// crosshair functionality.
//      * @param limelightName Name of the Limelight camera ("" for default)
//      * @return Vertical offset angle in degrees
//      */
...
//      * @return Array containing  [targetValid, targetCount, targetLatency, captureLatency, tx,
// ty, txnc, tync, ta, tid, targetClassIndexDetector,
...
//     /**
//      * Gets the camera's 3D pose with respect to the currently tracked target's coordinate
// system.
//      * @param limelightName Name/identifier of the Limelight
...
//     /**
//      * Gets the Pose2d and timestamp for use with WPILib pose estimator (addVisionMeasurement)
// when you are on the RED
//      * alliance
//      * @param limelightName
//      * @return
//      */
...
//         SetRobotOrientation_INTERNAL(limelightName, yaw, yawRate, pitch, pitchRate, roll,
// rollRate, true);
//     }

//     public static void SetRobotOrientation_NoFlush(String limelightName, double yaw, double
// yawRate,
//         double pitch, double pitchRate,
//         double roll, double rollRate) {
//         SetRobotOrientation_INTERNAL(limelightName, yaw, yawRate, pitch, pitchRate, roll,
...
//     private static void SetRobotOrientation_INTERNAL(String limelightName, double yaw, double
// yawRate,
//         double pitch, double pitchRate,
...
// the assist source more rapidly.
//      */
...
//      * Increasing downscale can improve performance at the cost of potentially reduced detection
// range.
//      *
//      * @param limelightName Name/identifier of the Limelight
...
//      */
//     public static void setCameraPose_RobotSpace(String limelightName, double forward, double
// side, double up, double roll, double pitch, double yaw) {
//         double[] entries = new double[6];
//         entries[0] = forward;
//         entries[1] = side;
//         entries[2] = up;
