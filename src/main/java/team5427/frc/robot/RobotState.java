...
public class RobotState {
    ...
    public RobotState(){
        this.odometry = new SwerveDriveOdometry(SwerveConstants.m_kinematics, Rotation2d.kZero, new SwerveModulePosition[4]);
        this.poseEstimator = new SwerveDrivePoseEstimator(SwerveConstants.m_kinematics, Rotation2d.kZero, new SwerveModulePosition[4], Pose2d.kZero, odometryStateStdDevs, VecBuilder.fill(0.4, 0.4, 9));

    }

    public void addOdometryMeasurement(double timestamp, Rotation2d rotation, SwerveModulePosition[] modulePoseModulePositions){
...
public void resetOdometryPose(Pose2d resetPose, SwerveModulePosition[] modulePositions, Rotation2d gyroAngle){
...
public void resetEstimatedPose(Pose2d resetPose, SwerveModulePosition[] modulePositions, Rotation2d gyroAngle){
...
return new Tuple2Plus<Double,Rotation2d>(Timer.getTimestamp(), this.odometry.getPoseMeters().getRotation()) ;
}

public void log(){
      Logger.recordOutput("Localization/Estimation/Robot", RobotState.getInstance().getEstimatedPose());
